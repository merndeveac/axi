...
function makeSession(): TradeDataCoverageSession {
  ...
  return {
    ...
    lifecycleEmbeddedEventCount: 0,
    lifecyclePersistedEventCount: 0,
    lifecycleResidual: 0,
    counterResiduals: {},
    ...
    latencyDistributions: {
      ...
      normalize_to_queue: unavailable,
      queue_wait: unavailable,
      database_write: unavailable,
      normalize_to_persist: unavailable,
      persist_to_timeseries: unavailable,
      commit_to_timeseries: unavailable,
      timeseries_to_signal_compute: unavailable,
      derivative_to_signal_compute: unavailable,
      signal_compute_to_scanner_projection: unavailable,
      scanner_projection_to_broadcast: unavailable,
      signal_compute_to_signal_persist: unavailable,
